    ...
    <aside className="flex flex-col w-56 shrink-0 h-screen sidebar-gradient border-r border-sidebar-border">
      ...
      <div className="flex items-center gap-2.5 px-4 py-5 border-b border-sidebar-border/60">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[9px] uppercase tracking-widest text-sidebar-foreground/35 font-medium mt-0.5">
            AI Platform
          </p>
        </div>
      </div>
      ...
      <nav className="flex-1 px-2 py-4 space-y-0.5 overflow-y-auto">
        <p className="px-3 pb-2 text-[9px] uppercase tracking-widest font-semibold text-sidebar-foreground/30">
          Workspace
        </p>
        {navItems.map(({ href, label, icon: Icon }) => {
          ...
          return (
            ...
            >
              ...
              <Icon className={cn("w-4 h-4 shrink-0", active ? "text-primary" : "text-sidebar-foreground/40")} />
        ...
        {isPlatformAdmin && (
          <div className="pt-4">
            ...
            <a
              href={getAdminAppUrl()}
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all text-sidebar-foreground/40 hover:text-destructive hover:bg-destructive/8 border border-transparent"
      ...
      {/* Footer */}
      <div className="px-3 py-3 border-t border-sidebar-border/60 space-y-2.5 bg-black/10">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-sidebar-foreground/35 truncate" data-testid="text-sidebar-org">
              {displayOrg}
            </p>
          </div>
          <button
