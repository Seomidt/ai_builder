...
export default function OpsJobs() {
  return (
    <div className="flex-1 overflow-y-auto p-6 space-y-6 max-w-6xl" data-testid="ops-jobs-page">
      <div>
        <h1 className="text-xl font-semibold text-foreground flex items-center gap-2" data-testid="text-ops-jobs-title">
          <Clock className="w-5 h-5 text-primary" /> Background Jobs
        </h1>
        <p className="text-sm text-muted-foreground mt-0.5">Job queue monitoring and execution status</p>
      </div>
