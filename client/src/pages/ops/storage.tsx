...
export default function OpsStorage() {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 space-y-6 max-w-6xl" data-testid="ops-storage-page">
      <div>
        <h1 className="text-xl font-semibold text-foreground flex items-center gap-2" data-testid="text-ops-storage-title">
          <HardDrive className="w-5 h-5 text-primary" /> Storage Management
        </h1>
        <p className="text-sm text-muted-foreground mt-0.5">File metadata, upload status, and storage health</p>
      </div>
